...
target_sources(artn_lua PRIVATE
...
##
set_target_properties(artn_lua
...
add_custom_command(TARGET artn_lua POST_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy
  "$<TARGET_FILE:artn_lua>" "${CMAKE_CURRENT_SOURCE_DIR}/lib/$<TARGET_FILE_NAME:artn_lua>")
