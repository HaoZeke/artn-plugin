...
elseif( lmp_cmake )
  ...
  message(FATAL_ERROR "LAMMPS_PATH incorrect, or Lammps not compiled by neither 'cmake' nor 'make'.")
endif()
...
if( "${pkg_plugin}" STREQUAL "")
  message(FATAL_ERROR "pARTn :: package PLUGIN is needed, but not found in LAMMPS.")
endif()
