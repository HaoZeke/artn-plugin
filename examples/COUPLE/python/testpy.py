...
pos_saddle = artn.extract("coords_sad")

delr_min1 = artn.extract("delr_min1")
delr_min2 = artn.extract("delr_min2")
ener_sad = artn.extract("energy_sad")
ener_min1 = artn.extract("energy_min1")
ener_min2 = artn.extract("energy_min2")

print( "delr_min1",delr_min1)
print( "delr_min2",delr_min2)


# access documentation of pypARTn:
# help( pypARTn )

# list all variables that can be set from python:
# artn.list_set()

# list all variables that can be extracted from pARTn:
# artn.list_extract()
