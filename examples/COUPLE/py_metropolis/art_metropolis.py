...
while iter < NUMBER_EVENTS :
   ...
   if err:
      ...
      with open("eventlist", "a") as feventlist :
         ...
         feventlist.write(f"  {ini_file}     {sad_file}     {fin_file}    {event_status} {ener_ini:9.4f}  {del_en:8.4f}  {en_sad:8.4f}      {delr_sad:8.4f}     {delr_ini:8.4f}     {delr_fin:8.4f}     {random_number:12.10}\n" )
