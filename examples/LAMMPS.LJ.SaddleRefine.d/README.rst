...
where the values indicate 12 steps of perpendicular relax to be done in the first ARTn step, followed by 24 in the next, and from the third step perform relax until the specified force convergence criterion is met, indicated by value -1.
