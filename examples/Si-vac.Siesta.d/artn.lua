-- This is a lua script which calls pARTn
...
function siesta_comm()
  ...
  -- this will contain just keys of which elements are returned to siesta
  ...
  if siesta.state == siesta.MOVE then
    ...
    -- write xyz of current conf before move
...
function move_artn( siesta )
  ...
  -- siesta.geom.fa = ...
  -- siesta.geom.fa = flos.Array.from(force_m)
