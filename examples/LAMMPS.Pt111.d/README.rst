...
See the files in ``reference.d`` directory for expected results. Read more about pARTn output files `here <https://mammasmias.gitlab.io/artn-plugin/user_guide/tutorial/partn_output.html>`_.
