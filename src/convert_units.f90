...
contains
  ...
  elemental pure module function convert_force( f )result( fau )
    real(DP), intent( in ) :: f
    real(DP) :: fau
    fau = f * F2au
  ...
  elemental pure module function unconvert_force( fau )result( f )
  ...
  elemental pure module function convert_hessian( h )result( hau )
    real(DP), intent( in ) :: h
    real(DP) :: hau
    hau = h * H2au
  ...
  !> @return a force in engine units
  elemental pure module function unconvert_hessian( hau )result( h )
  ...
  elemental pure module function convert_length( p )result( pau )
    real(DP), intent( in ) :: p
    real(DP) :: pau
    pau = p * L2au
  ...
  elemental pure module function unconvert_length( pau )result( p )
  ...
  elemental pure module function convert_energy( e )result( eau )
    real(DP), intent( in ) :: e
    real(DP) :: eau
    eau = e * E2au
  ...
  elemental pure module function unconvert_energy( eau )result( e )
  ...
  elemental pure module function convert_time( t )result( aut )
    real(DP), intent( in ) :: t
    real(DP) :: aut
    aut = t * T2au
  ...
  elemental pure module function unconvert_time( aut )result( t )
